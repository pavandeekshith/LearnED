-- Fix type mismatch error in get_teacher_invitations
-- The issue is that the table columns are VARCHAR but function returns TEXT

-- Drop the old function first
DROP FUNCTION IF EXISTS get_teacher_invitations(UUID);

-- Create the new function with correct types matching the table
